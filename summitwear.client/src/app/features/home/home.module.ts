...
import { SharedModule } from '../../shared/shared.module'; // A shared module for common components, pipes, or services
...
@NgModule({
  declarations: [HomeComponent, HeroComponent], // Declare the components to be used within this module
  imports: [
